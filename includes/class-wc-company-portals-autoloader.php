 ...
 * @author 		WooThemes
 */
class WC_Company_Portals_Autoloader {
	...
	public function __construct() {
		...
		$this->include_path = untrailingslashit( plugin_dir_path( WC_COMPANY_PORTALS_PLUGIN_FILE ) ) . '/includes/';
	}
...
new WC_Company_Portals_Autoloader();
